...
//         <h2 className="text-3xl font-bold mb-8 text-gray-900">LOAN CATEGORIES</h2>
//         <h2 className="text-3xl  mb-8 text-gray-800">The organization offers support in the following catagories</h2>
