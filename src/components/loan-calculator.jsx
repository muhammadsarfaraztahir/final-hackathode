...
//       <h3 className="text-2xl font-semibold text-gray-800 mb-6">Loan Calculator</h3>
...
//       {/* Loan Amount Input */}
//       <div className="mb-6">
//         <label className="block text-sm font-medium text-gray-700">Enter Loan Amount</label>
//         <input
//           type="number"
//           className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
//           placeholder="Enter Loan Amount"
...
//       {/* Initial Deposit Input */}
//       <div className="mb-6">
//         <label className="block text-sm font-medium text-gray-700">Enter Initial Deposit (optional)</label>
//         <input
//           type="number"
//           className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
//           placeholder="Enter Initial Deposit (if any)"
